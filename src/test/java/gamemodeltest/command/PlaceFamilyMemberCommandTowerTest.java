...
public class PlaceFamilyMemberCommandTowerTest {
	...
	public void setUp(){
		...
		t=new Tower();
		b=new RealBoard();
		c0=new RealCard(null,new Resource(3,3,3,0), new Resource(3,3,3,0),null, null, null, null, null);
		c1=new RealCard(null,new Resource(0,0,0,0), new Resource(0,0,0,0),null, null, null, null, null);
